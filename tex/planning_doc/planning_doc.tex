...
\begin{allintypewriter}
  out = gen\_f(gen\_spec['in'], gen\_specs['out'], params)
\end{allintypewriter}

\clearpage
\subsection{Example of calling functions}
\lstinputlisting[basicstyle=\footnotesize,frame=single,language=Python,title=\lstname,numberstyle=\tiny,numbers=left,firstline=36]{../../examples/GKLS_and_uniform_random_sample/call_libE_on_GKLS.py}
