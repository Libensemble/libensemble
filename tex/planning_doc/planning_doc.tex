...
\begin{allintypewriter}
  ...
  \begin{description}
    ...
    \item[sim\_specs]: [dict of dicts] one dict for each simulation.
      \begin{description}
        \item[sim\_f]: [func] that calls sim(s)
        \item[sim\_f\_params]: [dict] parameters for each sim\_f
        \item[n]: [int] dimension of simulation(s) parameters
        \item[m]: [int] dimension of simulation(s) output 
      \end{description}
    ...
    \begin{description}
      ...
      \item[Functionality:] \
        \begin{itemize}
          ...
          \item Generation performed by manager instead of workers
        \end{itemize}
    \end{description}
    \bigskip
  \item 
