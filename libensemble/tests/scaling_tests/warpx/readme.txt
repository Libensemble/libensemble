...
In the optimization process, some runs will have a luwer emittance (potentially 10x), and they may require a higher resolution to reach the same level of convergence.
Let us keep this in mind, and maybe add a res5 to the list above. This high-resolution one should also fit on 1 GPU, but it will be worth testing.
