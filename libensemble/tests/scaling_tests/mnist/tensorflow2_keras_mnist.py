...
# JLN 2020: This example comes from ALCF's Simulation, Data, and Learning tutorial
#   from December 2020, all sources files are from: https://github.com/argonne-lcf/sdl_ai_workshop
#   Adjustments for local runs, logging, fixes, and compatibility are listed throughout
...
# JLN 2020: Added scaled learning rate
...
if (with_hvd):
    ...
    # Horovod: average metrics among workers at the end of every epoch.
        ...
        # JLN 2020: Added scaled learning rate to callback
...
t1 = time.time()
if (hvd.rank()==0):
    # JLN 2020: Added line to save model following training.
    tf.keras.models.save_model(mnist_model, './final_model_'+time.asctime().replace(' ', '_')+'_keras_mnist.tf', save_format='tf')
