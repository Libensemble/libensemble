...
def test_checking_inputs_H0():
    ...
    H0 = np.array([(False, 0., 0, 0., 1, True, 1, True, [0., 0., 0.], 0.1, 1.1),
                   (False, 0., 0, 0., 1, True, 2, True, [0., 0., 0.], 0.2, 1.2),
                   (False, 0., 0, 0., 1, True, 3, True, [0., 0., 0.], 0.3, 1.3),
                   (False, 0., 0, 0., -1, False, 0, False, [0., 0., 0.], 0., inf),
                   (False, 0., 0, 0., -1, False, 0, False, [0., 0., 0.], 0., inf)],
