...
exp_jsrun = \
    ['jsrun -n 2 -r 2 --xarg 1 /path/to/fakeapp.x --testid base1',
     'jsrun -n 32 -r 16 /path/to/fakeapp.x --testid base2',
     'jsrun -n 32 -r 16 --xarg 1 /path/to/fakeapp.x --testid base3',
     'jsrun -n 128 -r 64 --xarg 1 /path/to/fakeapp.x --testid base4',
