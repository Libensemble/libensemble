...
from libensemble.tests.regression_tests.support import aposmm_gen_out as gen_out
...
from libensemble.gen_funcs.old_aposmm import aposmm_logic as gen_f  # noqa: E402
