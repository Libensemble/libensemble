...
Execute via one of the following commands (e.g. 3 workers):
   mpiexec -np 4 python test_persistent_sampling_adv.py
   python test_persistent_sampling_adv.py --nworkers 3 --comms local
   python test_persistent_sampling_adv.py --nworkers 3 --comms tcp
