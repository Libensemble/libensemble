...
__all__ = [
    ...
    "uniform_sample_diff_simulations_rets",
]

#TODO FOR HERE AND persistent_sampling.py - check examples giving in docstrings - exists and correct location or remove

#print (or log if use logger).
#thing is not always same for every func!
def _print_points(b, nprocs):
...
def uniform_sample_diff_simulations_rets(_, persis_info, gen_specs, libE_info):
    """
