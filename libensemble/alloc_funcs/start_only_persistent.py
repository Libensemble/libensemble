...
def only_persistent_adv(W, H, sim_specs, gen_specs, alloc_specs, persis_info):
    ...
    .. seealso::
        `test_persistent_uniform_sampling_adv.py <https://github.com/Libensemble/libensemble/blob/develop/libensemble/tests/regression_tests/test_persistent_uniform_sampling_adv.py>`_ # noqa
    """
