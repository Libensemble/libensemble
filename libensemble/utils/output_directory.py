...
class EnsembleDirectory:
    ...
    The toplevel ensemble directory typically stores unique subdirectories containing results
    ...
    def copy_back(self) -> None:
        ...
        if os.path.isdir(self.prefix) and self.ensemble_copy_back:
            ...
            if no_calc_dirs:
                ...
                for file in [i for i in os.listdir(self.prefix) if not p.match(i)]:  # each noncalc_dir file
