...
def wait(process: subprocess.Popen, timeout: float | None = None) -> int | None:
...
def wait_and_kill(process: subprocess.Popen, timeout: float | None) -> int:
...
def cancel(process: subprocess.Popen, timeout: float | None = 0) -> int:
