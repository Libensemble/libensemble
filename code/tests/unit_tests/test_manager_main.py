...
def test_termination_test():
    ...
    H, H_ind, term_test,_,_,_ = man.initialize(sim_specs_0, gen_specs_0, al, exit_criteria_0,[],libE_specs) 
    ...
    H, H_ind,term_test,_,_,_ = man.initialize(sim_specs, gen_specs, al, exit_criteria,H0,libE_specs) 
    H_ind = 4
