...
from six_hump_camel import six_hump_camel as sim_f

# Import gen_func 
sys.path.append(os.path.join(os.path.dirname(__file__), '../../examples/gen_funcs'))
from persistent_uniform_sampling import persistent_uniform as gen_f

# Import alloc_func 
sys.path.append(os.path.join(os.path.dirname(__file__), '../../examples/alloc_funcs'))
from start_only_persistent import only_persistent_gens as alloc_f
