...
:task.app: (app obj) Use application/executable, registered using exctr.register_calc
...
A list of Executor and task functions can be found under the ``executor`` module.
