...
.. seealso::
  ...
  `test_uniform_sampling_with_variable_resources.py.py`_.
...
.. _test_uniform_sampling_with_variable_resources.py.py: https://github.com/Libensemble/libensemble/blob/develop/libensemble/tests/regression_tests/test_uniform_sampling_with_variable_resources.py.py
