...
The foundation of writing libEnsemble routines is accounting for four components:
    ...
    1. The generator function :ref:`gen_f<api_gen_f>`, which produces values for
       simulations
    2. The simulator function :ref:`sim_f<api_sim_f>`, which performs simulations
       based on values from ``gen_f``
