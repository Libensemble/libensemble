...
that fits this interface. This could be acheived, for example, by inheriting
the built-in scheduler and and making modifications.

Options can also be provided to the scheduler though a special dictionary
``alloc_specs['user']['scheduler_opts']``.
