...
The manager maintains a global copy. Each row contains:
  ...
  1. Data generated by the :ref:`gen_f<funcguides-gen>`
  2. Resultant output from the :ref:`sim_f<funcguides-sim>`
...
:ref:`gen_f<funcguides-gen>` and :ref:`sim_f<funcguides-sim>` functions accept a local history
